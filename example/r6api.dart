...
void main() async {
  ...
  final profilById =
      await api.getById(Platform.uplay, 'be3313d6-d443-4eae-818f-bb7f56837781');
  final playtime = await api.getPlaytime(
      Platform.uplay, 'be3313d6-d443-4eae-818f-bb7f56837781');

  print(serverStatus);
  print(profilById);
  print(profilByUsername);
  print(playtime);
}
